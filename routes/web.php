...
Route::prefix('admin')->group(function () {
    ...
    Route::get('update_storage/{storage_id}', 'StorageController@update_storage')->middleware('admin_manager');
    ...
    Route::get('process_delete_storage/{storage}', 'StorageController@process_delete_storage')->middleware('admin');
