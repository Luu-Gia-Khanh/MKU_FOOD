                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control upper_val" type="text" name="voucher_name"
                                    value="{{ $voucher->voucher_name }}" onblur="return upberFirstKey()"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="product_id" value="{{ $voucher->product_id }}" class="custom-select2 form-control select2-hidden-accessible"
                                    ...
                                    @foreach ($all_product as $product)
                                        <option value="{{ $product->product_id }}"
                                            @if ($product->product_id == $voucher->product_id)
                                                selected
                                            @endif
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="datetime-local" name="start_date"
                                    value="{{ strftime('%Y-%m-%dT%H:%M:%S', strtotime($voucher->start_date)) }}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="datetime-local" name="end_date"
                                    value="{{ strftime('%Y-%m-%dT%H:%M:%S', strtotime($voucher->end_date)) }}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="voucher_quantity"
                                    value="{{ $voucher->voucher_quantity }}" placeholder="Nhập Số Lượng Của Voucher">
