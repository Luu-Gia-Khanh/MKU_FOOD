                    ...
                    <div class="d-flex justify-content-between pb-10">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                <a class="dropdown-item" href="{{ URL::to('admin/all_customer') }}"><i
                                        class="dw dw-eye"></i>
                                    Chi Tiết
                                </a>
                            </div>
                                    ...
                                    <div class="name-avatar d-flex align-items-center pr-2">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('public/upload/' . $customer->customer_avt) }}"
                                                class="border-radius-100 box-shadow" style="width: 50px; height: 50px"
                                                alt="">
                                        </div>
                                        <div class="txt">
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="cta flex-shrink-0">
                                        <span class="btn btn-sm btn-outline-secondary"
                                            ...
                                            {{ $product['avg_rating'] }}
                                            <i class="icon-copy fa fa-star" aria-hidden="true"
                                                style="color: #fddf0a; font-size: 18px"></i>
                                        </span>
                                    </div>
                                </li>
                            @endforeach
