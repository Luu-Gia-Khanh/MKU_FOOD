                        ...
                        <ul>
                            @foreach ($time_line_his as $time)
                                <li>
                                    ...
                                    <a href="#detail_time_line_{{ date('d_m_Y_H_i_s', strtotime($time->action_time)) }}" data-toggle="collapse"  class="task-name">{{ $time->action_message }}</a>
                                    <p>
                                        <table class="table table-bordered collapse" id="detail_time_line_{{ date('d_m_Y_H_i_s', strtotime($time->action_time)) }}" style="font-size: 13px">
                                            <tr>
                                                <th>Sản Phẩm</th>
