                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    @foreach ($recycle_item as $recy)
                                        <tr>
                                                    ...
                                                    <td class="table-plus sorting_1" tabindex="0">
                                                        <div class="da-card box-shadow" style="height: 80px; width: 80px">
                                                            <div class="da-card-photo">
                                                                <img src="{{ asset('public/upload/'.$product->product_image) }}" alt="hình ảnh" style="height: 80px !important; width: 80px !important;" srcset="">
                                                            </div>
                                                        </div>
                                                    </td>
                                            ...
                                            @endforeach
                                            <td class="col-4">
                                                <a href="{{ URL::to('admin/re_delete_storage_product/'.$recy->storage_product_id) }}" class="btn color-btn-them"
                                                    > Khôi Phục</a>
                                                <button class="btn btn-danger btn_delete_forever" data-id="{{ $recy->storage_product_id }}" data-toggle="modal" data-target="#delete_forever"> Xóa Vĩnh Viễn</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
