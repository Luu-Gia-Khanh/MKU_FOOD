                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        ...
                                                        <button class="dropdown-item soft_delete_storage_product_class" data-id="{{ $storage_product->storage_product_id }}" data-toggle="modal"
                                                            data-target="#Modal_delete"><i class="dw dw-delete-3"></i>Xóa</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
