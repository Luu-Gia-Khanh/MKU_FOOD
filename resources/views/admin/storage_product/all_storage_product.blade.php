    ...
    <div class="min-height-200px">
        ...
        <div class="card-box mb-30">
            <div class="content_filter_storage_product">
                <div class="row pd-20">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Danh Sách Kho Sản Phẩm</h4>
                    </div>
                </div>
                <div class="pb-20">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                ...
                                                                <button class="dropdown-item soft_delete_storage_product_class" data-id="{{ $storage_product->storage_product_id }}" data-toggle="modal" data-target="#Modal_delete"><i class="dw dw-delete-3"></i>Xóa</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
