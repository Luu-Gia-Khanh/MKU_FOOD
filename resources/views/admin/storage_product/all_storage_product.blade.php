                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer ">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item" href="{{ URL::to('admin/import_storage_product/' . $storage_product->storage_product_id) }}"><i
                                                                            class="icon-copy dw dw-add"></i>Nhập hàng</a>
                                                                    <a class="dropdown-item" href="{{ URL::to('admin/history_storage_product/' . $storage_product->storage_product_id) }}"><i
                                                                            class="dw dw-eye"></i>Xem Lịch sử</a>
                                                                    <a class="dropdown-item" href="{{ URL::to('admin/update_storage_product/' . $storage_product->storage_product_id) }}"><i
                                                                            class="dw dw-edit2"></i>Chỉnh Sửa</a>
                                                                    <button class="dropdown-item soft_delete_storage_product_class" data-id="{{ $storage_product->storage_product_id }}"
                                                                        data-toggle="modal" data-target="#Modal_delete"><i class="dw dw-delete-3"></i>Xóa</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <a href="{{ URL::to('admin/view_recycle_storage_product/' . $storage_id) }}" class="btn color-btn-them ml-10" style="color: white"><i class="dw dw-delete-3"></i>Thùng
                                    Rác</a>
                            </div>
