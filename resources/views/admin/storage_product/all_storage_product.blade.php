                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left" style="">
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                                data-target="#Modal_filter_storage_product_follow_quantity">Số lượng sản
                                                phẩm trong kho</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        data-defaultsign="AZ">Tên Sản Phẩm</th>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1">Số lượng
                                                    </th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ URL::to('admin/soft_delete_storage_product') }}" method="post"
                            name="form_soft_delete">
                            @csrf
