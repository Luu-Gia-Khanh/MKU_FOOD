...
<div class="min-height-200px">
            ...
            <div class="col-md-12 col-sm-12">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Danh sách đơn hàng chờ xác nhận</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card-box mb-30">
        <div class="row pd-20">
            <div class="pd-20">
                <h4 class="text-blue h4">Danh Sách Đơn Hàng Chờ Xác Nhận</h4>
            </div>
        </div>
        @if (count($orders) > 0)
            <div class="pb-20">
                                    ...
                                    <tbody id="table_search">
                                        ...
                                        @foreach ($orders as $order)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success btn_confirm_order" data-toggle="modal" data-target="#modal_confirm_order" data-id="{{ $order->order_code }}"><span class="icon-copy ti-check-box" ></span> Xác Nhận</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
        ...
        @else
            <div class="center pd-10">Không có đơn hàng nào đang chờ xác nhận</div>
        @endif

    </div>
</div>
<!-- The Modal -->
<div class="modal fade" id="modal_confirm_order">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="modal_body">Xác nhận đơn hàng ?</div>
            <form action="{{ URL::to('admin/confirm_order') }}" method="post" name="form_submit_confirm_order">
                @csrf
