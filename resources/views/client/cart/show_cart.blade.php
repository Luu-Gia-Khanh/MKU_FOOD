                    ...
                    <div class="shopping-cart-container">
                        <div class="row">
                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form class="shopping-cart-form form_checkbox_cart" action="{{ URL::to('checkout') }}"
                                    method="post" name="form_show_cart">
                                    @csrf
                                                ...
                                                <tr class="cart_item">
                                                    <td>
                                                        <label class="container-checkbox" style="margin-left: 10px">
                                                            <input type="checkbox"
                                                                class="check_item_{{ $cart->cart_id }} item_check"
                                                                name="itemCart[]" value="{{ $cart->cart_id }}" checked>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                                            ...
                                                            <div class="qty-input">
                                                                ...
                                                                @foreach ($product_storage as $sto_prod)
                                                                    @if ($cart->product_id == $sto_prod->product_id)
                                                                        <input type="hidden"
                                                                            class="max_val_{{ $cart->cart_id }}"
                                                                            value="{{ $sto_prod->total_quantity_product }}">
                                                                    @endif
                                                                @endforeach
                                                                {{-- end get max val product --}}
                                                                <a href="#"
                                                                    class="qty-btn btn-up btn_up_update_cart btn_up_update_cart_{{ $cart->cart_id }}"
                                                                    data-id="{{ $cart->cart_id }}"><i
                                                                        class="fa fa-caret-up" aria-hidden="true"></i></a>
                                                                <a href="#"
                                                                    class="qty-btn btn-down btn_down_update_cart btn_down_update_cart_{{ $cart->cart_id }}"
                                                                    data-id="{{ $cart->cart_id }}"><i
