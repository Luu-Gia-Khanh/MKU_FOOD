                ...
                <div class="content-add-address">
                    <form name="update_transport">
                        ...
                        <div class="line">
                            ...
                            <input type="text" class="form-control input fullname_address_update check_format_name_input" id="trans_fullname" value="{{ old('trans_fullname') }}" placeholder="Họ và tên">
                            <div class="" style="width: 50px"></div>
