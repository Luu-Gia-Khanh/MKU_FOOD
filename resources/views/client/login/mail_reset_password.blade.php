			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        @endif
                        {{-- FORM --}}
						<form action="{{ URL::to('process_mail_reset_password') }}" method="post" style="text-align: center" >
							@csrf
							<div class="input-group custom">
								<input type="email" name="email" value="{{ old('email') }}" class="form-control form-control-lg" placeholder="Nhập email">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0 btn-login">
										<input type="submit" class="btn btn-lg btn-block" style="background-color: #7faf51; color:white;" value="Gửi" />
									</div>
								</div>
							</div>
						</form>
