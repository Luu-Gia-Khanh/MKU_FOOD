            ...
            <div id="main-content" class="main-content">
                ...
                <div class="sumary-product single-layout cus_bg_product_detail" style="min-height: 700px;">
                    ...
                    <div class="product-attribute">
                        ...
                        <div class=" excerpt"
                            style="padding-right: 20px">{!! $product->product_sort_desc !!}
                    </div>
                    <div class="price">
                ...
                <div class="action-form" style="border: 1px solid #0000000d;">
                    ...
                    <div class="row">
                        <div class="buttons">
                            ...
                            @if (Session::get('customer_id'))
                                <a href="#" class="btn add-to-cart-btn btn-block btn-sm add_cart_many add_cart_many_detail"
                                    data-id="{{ $product->product_id }}" style="margin-left: 0px">thêm vào giỏ hàng</a>
                            @else
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                                    @if (Session::get('able_rating_comment_' . $product->product_id))
                                        <div class="review-form-wrapper">
                                            ...
                                            <p class="form-row">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                <textarea name="comment" class="comment_message" id="txt_comment" cols="30"
                                                    rows="10" style="max-width: 500px;"
                                                                        ...
                                                                        @if ($comment->customer_id == $customer->customer_id)
                                                                            ...
                                                                            <div class="content-name-rating">
                                                                                <p class="comment-in"><span
                                                                                        class="post-name"
                                                                                        style="font-size: 17px">{{ $customer->username }}</span>
                                                                                </p>
                                                                                <div class="rating">
                                                                                    <p class="star-rating">
                                                                                        @php
                        ...
                        <ul class="actions">
                            ...
                            @if (isset($session))
                                <li><a class="btn-act like btn_useful_comment btn_useful_comment_{{ $comment->comment_id }}"
                                        style="color: #7faf51; cursor: pointer;" data-id="{{ $comment->comment_id }}">
                                        <i class="fa fa-thumbs-up" aria-hidden="true"></i>
                                        <span class="txt_count_comment_useful_{{ $comment->comment_id }}">Hữu ích
                                            ({{ $comment->comment_useful }})</span>
                                    </a></li>
