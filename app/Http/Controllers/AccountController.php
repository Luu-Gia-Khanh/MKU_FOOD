...
class AccountController extends Controller
{
    ...
    public function order_account(){
        ...
        $status_order_confirm = Order_Detail_Status::where('status_id', 1)->get();
        $status_order_delivering = Order_Detail_Status::where('status_id', 3)->get();
        $status_order_delivered = Order_Detail_Status::where('status_id', 4)->get();
        $status_order_cancelled = Order_Detail_Status::where('status_id', 5)->get();
