...
//                     var I = z.bbox();
//                     if (r) {
//                         var M = this.graphics.drawRect(I.x - v, I.y - C, I.width + v + w, I.height + A + C, x, u, 1, f, b, p);
//                         T.insertBefore(M.node, z.node)
//                     }
...
//                             if (l.length && h.push(l.join(s)), t.data && t.data.length)
...
//                         n.add(k)
//                     }
//                     return e.config.yaxis[t].axisTicks.show && this.axesUtils.drawYAxisTicks(w, l, y, e.config.yaxis[t].axisTicks, t, h, n), n
//                 }
//             }, {
...
//                                 } else
//                                     for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = I.extendArrayProps(r, s[l].options), t = g.extend(i.config, t), e.overrideResponsiveOptions(t))
//                             };
//                         if (t) {
...
//                         },
//                         a = i();
//                     if (a.setAttribute("class", "apexcharts-toolbar"), e.globals.dom.elWrap.appendChild(a), this.elZoom = i(), this.elZoomIn = i(), this.elZoomOut = i(), this.elPan = i(), this.elSelection = i(), this.elZoomReset = i(), this.elMenuIcon = i(), this.elMenu = i(), this.elCustomIcons = [], this.t = e.config.chart.toolbar.tools, Array.isArray(this.t.customIcons))
...
//                     if (o && p[0] && c.tooltipTitle)
//                         if (null == d || h.globals.collapsedSeriesIndices.indexOf(i) > -1 ? p[0].parentNode.style.display = "none" : p[0].parentNode.style.display = h.config.tooltip.items.display, 0 === h.globals.stackedSeriesTotals[a]) {
...
//                     var d = r;
//                     a.globals.isXNumeric && "datetime" === a.config.xaxis.type ? r = new R(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d) : a.globals.isBarHorizontal || (r = a.globals.xLabelFormatter(d, h));
...
//                     }
//                     for (var p, x = i, b = 0, m = 0; m < this.prevYF.length; m++) b += isNaN(this.prevYF[m][d]) ? 0 : this.prevYF[m][d];
//                     if (c > 0 && !h.globals.isXNumeric || c > 0 && h.globals.isXNumeric && h.globals.seriesX[c - 1][d] === h.globals.seriesX[c][d]) {
//                         var v, y, w = Math.min(this.yRatio.length + 1, c + 1);
...
//                             }
//                         }
//                         p = this.prevYF[0].every((function (t) {
//                             return 0 === t
...
//                             for (k = 1, A = b.length; k < A; k++) w = b[k - 1][2], S = w.x, C = w.y, w = b[k][0], L = w.x, P = w.y, w = b[k][1], E = w.x, Y = w.y, R.push(["C", S, C, L, P, E, Y]);
//                             return R
//                         }(this.pos, t))[0]
//                 }
